...
urlpatterns = [
    ...
    path(
        "web/courses/<int:pk>/update/", CourseUpdateView.as_view(), name="course_update"
    ),
    path(
        "web/courses/<int:pk>/delete/", CourseDeleteView.as_view(), name="course_delete"
    ),
    path("web/lessons/create/", LessonCreateView.as_view(), name="lesson_create"),
    path(
        "web/lessons/<int:pk>/update/", LessonUpdateView.as_view(), name="lesson_update"
    ),
    path(
        "web/lessons/<int:pk>/delete/", LessonDeleteView.as_view(), name="lesson_delete"
    ),
]
